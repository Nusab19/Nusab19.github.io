    ...
    >
      <div className="container mx-auto">
        <div className="flex min-h-screen flex-row items-center justify-center">
          ...
          <hr className="mt-14 w-[300px] border-t-4 rounded-sm border-[#f3f4f6] md:mt-20 md:w-[500px] absolute" />

          <span className="ml-3 mt-3 h-4 w-4 rounded-full bg-[#00bbd4] md:mt-7 md:h-5 md:w-5"></span>
        </div>
      </div>

      <span className="come-in absolute top-[20vh] -translate-x-1/2 text-[#00d49f] blur-sm">
        {blob}
      </span>
      <span className="come-in absolute bottom-[23vh] left-[13vw] text-[#dad7cd] blur-sm">
        {blob}
      </span>
      <span className="come-in absolute bottom-[10vh] right-[20vw] text-[#f35f5f] blur-sm">
        {blob}
      </span>
      <span className="come-in absolute right-[30vw] top-[15vh] text-[#219ebc] blur-sm">
        {blob}
      </span>
      <span className="come-in absolute right-0 top-[40vh] translate-x-1/2 text-[#8d99ae] blur-sm">
        {blob}
      </span>
    </div>
  );
